...
from tools.date_and_time import string_to_date, string_to_datetime, date_to_string, datetime_timezone
...
class AnswerChecker:
        ...
        if self.provided_report and self.answer['import_data'] and self.answer['init_data']:
            ...
            for record in self.answer['init_data']:
                for item in self.provided_report.provided_report_records:
                    ...
                    if record['fio'] == tmp.person_appeal and date_to_string(record['birthday']) == tmp.birthday:
    ...
    def save(self):
        ...
        if answer_import:
            ...
            answer_import.created_utc = datetime_timezone()
        ...
        for item in self.answer['init_data']:
            ...
            if answer_init:
                ...
                answer_init.created_utc = datetime_timezone()
